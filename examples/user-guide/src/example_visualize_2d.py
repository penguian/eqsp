...
def main():
    ...
    >>> main()
    --- Visualizing EQ Partition with N=100 ---
    Projection generated. Run plt.show() to view if in an interactive session.
    """
    N = 100
    ...
    print(f"--- Visualizing EQ Partition with N={N} ---")

    # Show a specific projection of a partition

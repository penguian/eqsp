...
When modifying scripts in `scripts/`, `doc/maint/`, or project-wide documentation (Maintenance/User Guides), you MUST perform the following checks before concluding the session.

#!/usr/bin/env python3
"""Benchmark for eq_find_s2_region (Vectorized histogram lookup)."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Benchmark for histograms.")
    parser.add_argument(
        "--n-max",
        type=int,
        default=10000000,
    ...
    run_histograms(
        n_max=args.n_max, n_regions=args.regions, even_collars=args.even_collars
    )
